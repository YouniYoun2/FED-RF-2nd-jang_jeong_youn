...
/*****************************************************
    ...
    2. 이때 미니언즈 이미지가 3개씩 있으므로 3의 배수로 표시해준다.
        ...
        [3] 파란박스 리셋하기
        1. 리셋버튼을 클릭하면 파란 박스의 미니언즈 이미지가 모두 삭제된다.
...
// 0부터 시작하여 미니언즈 개수보다 작을 때까지 반복한다.
// 왜 1이 아닌 0부터 시작인가? HTML컬렉션이 0부터 시작함(유사배열)
...
function insertMini(){
    ...
    for(let i=0; i<num; i++) {
        Bcase.innerHTML += `
            ...
            alt="미니언즈">
        `;
        count++;    // 미니언즈 이미지 개수 증가하기
    }   ////////// for문 ///////////

    // 4. 미니언즈 개수 출력하기
    // 대상 : .stxt span -> stxt 변수
    // 미니언즈 이미지에 3마리의 미니언즈가 있으니 *3으로 출력
